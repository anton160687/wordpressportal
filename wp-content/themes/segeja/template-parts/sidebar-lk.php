            ...
            <div class="card-body pt-9 pb-0">
                ...
                <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                    ...
                    <li class="nav-item mt-2">
                        <a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="pages/user-profile/overview.html">Основное</a>
                    </li>
                    <!--end::Nav item-->
                    <!--begin::Nav item-->
                    <li class="nav-item mt-2">
                        <a class="nav-link text-active-primary ms-0 me-10 py-5" href="pages/user-profile/projects.html">Лес возможностей</a>
                    </li>
                    <!--end::Nav item-->
        ...
        <div class="row g-5 g-xxl-8">
            ...
            <div class="col-xl-6">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex align-items-center flex-grow-1">
                                ...
                                <div class="symbol symbol-45px me-5">
                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/media/avatars/300-6.jpg" alt="">
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Info-->
                                <div class="d-flex flex-column">
                                    <a href="#" class="text-gray-900 text-hover-primary fs-6 fw-bold">Грейс Грин</a>
                            ...
                            <div class="my-0">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px" data-kt-menu="true">
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <div class="menu-content fs-6 text-gray-900 fw-bold px-3 py-4">Быстрые действия</div>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu separator-->
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="#" class="menu-link px-3">Новая заявка</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="#" class="menu-link px-3">Новый клиент</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3" data-kt-menu-trigger="hover" data-kt-menu-placement="right-start">
                                        <!--begin::Menu item-->
                                        <a href="#" class="menu-link px-3">
                                            <span class="menu-title">Новая группа</span>
                                            <span class="menu-arrow"></span>
                                        </a>
                                        <!--end::Menu item-->
                                        <!--begin::Menu sub-->
                                        <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="#" class="menu-link px-3">Группа администраторов</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="#" class="menu-link px-3">Группа сотрудников</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="#" class="menu-link px-3">Группа участников</a>
                                            </div>
                                            <!--end::Menu item-->
                                        </div>
                                        <!--end::Menu sub-->
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="#" class="menu-link px-3">Новый контакт</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu separator-->
                                    ...
                                    <div class="menu-item px-3">
                                        <div class="menu-content px-3 py-3">
                                            <a class="btn btn-primary btn-sm px-4" href="#">Сформировать отчеты</a>
                                        </div>
                                    </div>
                                    <!--end::Menu item-->
                                </div>
                    ...
                    <div class="card-body pb-0">
                        ...
                        <div class="d-flex align-items-center mb-5">
                            ...
                            <div class="d-flex align-items-center flex-grow-1">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-45px me-5">
                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/media/avatars/300-23.jpg" alt="">
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Info-->
                                <div class="d-flex flex-column">
                                    <a href="#" class="text-gray-900 text-hover-primary fs-6 fw-bold">Ник Логан</a>
                                    <span class="text-gray-500 fw-bold">PHP, SQLite, Artisan CLI</span>
                                </div>
                                <!--end::Info-->
                            </div>
                        ...
                        <div class="mb-5">
                            <!--begin::Text-->
                            <p class="text-gray-800 fw-normal mb-5">План помогает сохранять честность: он не дает увязнуть в неудачных метафорах про вождение и заставляет концентрироваться на общей структуре записи.</p>
                            <!--end::Text-->
                            <!--begin::Toolbar-->
                            <div class="d-flex align-items-center mb-5">
                        ...
                        <form class="position-relative mb-6">
                            <textarea class="form-control border-0 p-0 pe-10 resize-none min-h-25px" data-kt-autosize="true" rows="1" placeholder="Ответ..." data-kt-initialized="1" style="overflow: hidden; overflow-wrap: break-word; text-align: start; height: 25px;"></textarea>
                    ...
                    <div class="card-body pb-0">
                        ...
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="d-flex align-items-center flex-grow-1">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-45px me-5">
                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/media/avatars/300-21.jpg" alt="">
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Info-->
                                <div class="d-flex flex-column">
                                    <a href="#" class="text-gray-900 text-hover-primary fs-6 fw-bold">Карлес Нильсон</a>
                                    <span class="text-gray-500 fw-bold">Вчера в 17:06</span>
                                </div>
                                <!--end::Info-->
                            </div>
                            <!--end::User-->
                        ...
                        <div class="mb-7">
                            <!--begin::Text-->
                            <div class="text-gray-800 mb-5">План помогает сохранять честность: он не дает увязнуть в неудачных метафорах про вождение и заставляет концентрироваться на общей структуре записи.</div>
                            <!--end::Text-->
                            <!--begin::Toolbar-->
                            <div class="d-flex align-items-center mb-5">
                                <a href="#" class="btn btn-sm btn-light btn-color-muted btn-active-light-success px-4 py-2 me-4">
                        ...
                        <div class="mb-7">
                            ...
                            <div class="d-flex mb-5">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-45px me-5">
                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/media/avatars/300-14.jpg" alt="">
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Info-->
                                <div class="d-flex flex-column flex-row-fluid">
                                    ...
                                    <div class="d-flex align-items-center flex-wrap mb-1">
                                        <a href="#" class="text-gray-800 text-hover-primary fw-bold me-2">Алиса Данчик</a>
                                        <span class="text-gray-500 fw-semibold fs-7">1 день</span>
                                        <a href="#" class="ms-auto text-gray-500 text-hover-primary fw-semibold fs-7">Ответить</a>
                                    </div>
                                    <!--end::Info-->
                                    <!--begin::Post-->
                                    <span class="text-gray-800 fs-7 fw-normal pt-1">Еще до того как сесть за цифровое перо, нужно заранее выделить время и настроиться на работу.</span>
                                    <!--end::Post-->
                                </div>
                                <!--end::Info-->
                            </div>
                            ...
                            <div class="d-flex">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-45px me-5">
                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/media/avatars/300-9.jpg" alt="">
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Info-->
                                <div class="d-flex flex-column flex-row-fluid">
                                    <!--begin::Info-->
                                    <div class="d-flex align-items-center flex-wrap mb-1">
                                        <a href="#" class="text-gray-800 text-hover-primary fw-bold me-2">Харрис Болд</a>
                                        <span class="text-gray-500 fw-semibold fs-7">2 дня</span>
                                        <a href="#" class="ms-auto text-gray-500 text-hover-primary fw-semibold fs-7">Ответить</a>
                                    </div>
                                    <!--end::Info-->
                                    <!--begin::Post-->
                                    <span class="text-gray-800 fs-7 fw-normal pt-1">Планы помогают держать себя в рамках и не увлекаться сомнительными идеями.</span>
                                    <!--end::Post-->
                                </div>
                                <!--end::Info-->
                            </div>
                    ...
                    <div class="card-body pb-0">
                        ...
                        <div class="d-flex align-items-center mb-5">
                            ...
                            <div class="d-flex align-items-center flex-grow-1">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-45px me-5">
                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/media/avatars/300-7.jpg" alt="">
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Info-->
                                <div class="d-flex flex-column">
                                    <a href="#" class="text-gray-900 text-hover-primary fs-6 fw-bold">Карлес Нильсон</a>
                                    <span class="text-gray-500 fw-bold">На прошлой неделе в 22:00</span>
                                </div>
                                <!--end::Info-->
                            </div>
                            <!--end::User-->
                    ...
                    <div class="card-body pb-0">
                        ...
                        <div class="d-flex align-items-center mb-5">
                            ...
                            <div class="d-flex align-items-center flex-grow-1">
                                ...
                                <!--begin::Info-->
                                <div class="d-flex flex-column">
                                    <a href="#" class="text-gray-800 text-hover-primary fs-6 fw-bold">Карлес Нильсон</a>
                                    <span class="text-gray-500 fw-bold">На прошлой неделе в 22:00</span>
                                </div>
                                <!--end::Info-->
                            </div>
                        ...
                        <!--begin::Reply input-->
                        <form class="position-relative mb-6">
                            <textarea class="form-control border-0 p-0 pe-10 resize-none min-h-25px" data-kt-autosize="true" rows="1" placeholder="Ответ..." data-kt-initialized="1" style="overflow-x: hidden; overflow-wrap: break-word;"></textarea>
                            <div class="position-absolute top-0 end-0 me-n5">
															<span class="btn btn-icon btn-sm btn-active-color-primary pe-0 me-2">
																<i class="ki-duotone ki-paper-clip fs-2 mb-3"></i>
															</span>
                ...
                <button class="btn btn-primary w-100 text-center" id="kt_widget_5_load_more_btn">
                    <span class="indicator-label">Больше новостей</span>
                ...
                <div class="card mb-5 mb-xxl-8">
                    ...
                    <div class="card-header align-items-center border-0 mt-4">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="fw-bold mb-2 text-gray-900">Важные мероприятия</span>
                            <span class="text-muted fw-semibold fs-7">890 344 продаж</span>
                        </h3>
                        <div class="card-toolbar">
                            ...
                            <!--begin::Menu 1-->
                            <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_65a12146ea996">
                                <!--begin::Header-->
                                <div class="px-7 py-5">
                                    <div class="fs-5 text-gray-900 fw-bold">Параметры фильтра</div>
                                </div>
                                <!--end::Header-->
                                <!--begin::Menu separator-->
                                ...
                                <div class="px-7 py-5">
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <!--begin::Input-->
                                        <div>
                                            <select class="form-select form-select-solid select2-hidden-accessible" multiple="" data-kt-select2="true" data-close-on-select="false" data-placeholder="Выберите вариант" data-dropdown-parent="#kt_menu_65a12146ea996" data-allow-clear="true" data-select2-id="select2-data-11-hs8t" tabindex="-1" aria-hidden="true" data-kt-initialized="1">
                                                <option></option>
                                            ...
                                            </select><span class="select2 select2-container select2-container--bootstrap5" dir="ltr" data-select2-id="select2-data-12-k4ix" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--multiple form-select form-select-solid" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="-1" aria-disabled="false"><ul class="select2-selection__rendered" id="select2-dk63-container"></ul><span class="select2-search select2-search--inline"><textarea class="select2-search__field" type="search" tabindex="0" autocorrect="off" autocapitalize="none" spellcheck="false" role="searchbox" aria-autocomplete="list" autocomplete="off" aria-label="Search" aria-describedby="select2-dk63-container" placeholder="Выберите вариант" style="width: 100%;"></textarea></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                        </div>
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    <div class="mb-10">
                                        <!--begin::Label-->
                                        <label class="form-label fw-semibold">Тип участника:</label>
                                        <!--end::Label-->
                                        <!--begin::Options-->
                                        <div class="d-flex">
                                            <!--begin::Options-->
                                            <label class="form-check form-check-sm form-check-custom form-check-solid me-5">
                                                ...
                                                <span class="form-check-label">Автор</span>
                                            </label>
                                            <!--end::Options-->
                                            <!--begin::Options-->
                                    ...
                                    <div class="mb-10">
                                        <!--begin::Label-->
                                        <label class="form-label fw-semibold">Уведомления:</label>
                                        <!--end::Label-->
                                        <!--begin::Switch-->
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <button type="reset" class="btn btn-sm btn-light btn-active-light-primary me-2" data-kt-menu-dismiss="true">Сбросить</button>
                    ...
                    <div class="card-body pt-5">
                        ...
                        <div class="timeline-label">
                            ...
                            <div class="timeline-item">
                                ...
                                <!--end::Badge-->
                                <!--begin::Text-->
                                <div class="fw-mormal timeline-content text-muted ps-3">Структура помогает оставаться честными и держать повествование в порядке.</div>
                                <!--end::Text-->
                            </div>
                            <!--end::Item-->
                            <!--begin::Item-->
                            <div class="timeline-item">
                                ...
                                <div class="timeline-content d-flex">
                                    <span class="fw-bold text-gray-800 ps-3">Встреча AEOL</span>
                                </div>
                                <!--end::Content-->
                            </div>
                            <!--end::Item-->
                            ...
                            <div class="timeline-item">
                                ...
                                <!--end::Badge-->
                                <!--begin::Desc-->
                                <div class="timeline-content fw-bold text-gray-800 ps-3">Внести депозит
                                    <a href="#" class="text-primary">USD 700</a> для ESL</div>
                                <!--end::Desc-->
                            </div>
                            <!--end::Item-->
                            <!--begin::Item-->
                            <div class="timeline-item">
                                ...
                                <!--end::Badge-->
                                <!--begin::Text-->
                                <div class="timeline-content fw-mormal text-muted ps-3">Не позволять себе сомнительных решений и держать структуру проекта в идеале.</div>
                                <!--end::Text-->
                            </div>
                            <!--end::Item-->
                            <!--begin::Item-->
                            <div class="timeline-item">
                                ...
                                <!--end::Badge-->
                                <!--begin::Desc-->
                                <div class="timeline-content fw-semibold text-gray-800 ps-3">Размещен новый заказ
                            ...
                            <div class="timeline-item">
                                ...
                                <!--end::Badge-->
                                <!--begin::Text-->
                                <div class="timeline-content fw-mormal text-muted ps-3">Подготовительное совещание по запуску мобильного приложения Finance KPI</div>
                                <!--end::Text-->
                            </div>
                            <!--end::Item-->
                        </div>
