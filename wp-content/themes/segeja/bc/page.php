                ...
                <div class="d-flex flex-column flex-column-fluid">
                                    ...
                                    <?php if(is_single() || is_page() && !is_front_page()): ?>
                                        ...
                                        <li class="breadcrumb-item text-muted">
                                            ...
                                            foreach ($ancestors as $ancestor_id) {
                                                ...
                                                echo '<a href="' . get_permalink($parent->ID) . '" class="text-muted text-hover-primary">' . $parent->post_title . '</a>';
                    ...
                    <div id="kt_app_content" class="app-content flex-column-fluid">
                        ...
                        <div id="kt_app_content_container" class="app-container container-fluid">
                            ...
                            <?php the_content(); ?>
                            <?php endwhile; endif; ?>
                            <!-- Начало блока вывода ACF полей -->



                            <?php

                            $bethday = get_field('дата_рождения');

                            // Проверяем наличие значения и выводим его
                            if(!empty($bethday)): ?>
                                <p><strong>Дата рождения:</strong> <?= $bethday ?></p>
                            <?php endif; ?>

                            <?php
                            // Получаем значение поля "адрес"
                            $hobbies = get_field('мои_увлечения');

                            // Проверяем наличие значения и выводим его
                            if(!empty($hobbies)): ?>
                                <p><strong>Мои увлечения:</strong> <?= $hobbies ?></p>
                            <?php endif; ?>
